function [ data ] = extractCrackleFeatures( filepath )
...
crackles_estimate = CountCrackles( wave, t, fs );

% OUTPUT
data = [max_med, ... % Frequency of max signal
        LF_max/avg_low, MF_max/avg_med, HF_max/avg_high... % Ratio max signal to avg signal
        ...
        crackles_estimate]; % Quantity of crackles detected
end
